...
LLVMValueRef PlayRoutineHandler(Ast *ast, JITLangCtx *ctx, LLVMModuleRef module,
  ...
  Type *scheduler_type = scheduler_ast->type;
...
static LLVMValueRef build_async_cor_wrapper(LLVMTypeRef promise_type,
                                            LLVMValueRef scheduler,
                                            LLVMTypeRef scheduler_type,
                                            LLVMModuleRef module,
                                            LLVMBuilderRef builder) {
...
LLVMValueRef PlayRoutineAsyncHandler(Ast *ast, JITLangCtx *ctx,
                                     LLVMModuleRef module,
                                     LLVMBuilderRef builder) {
  ...
  LLVMValueRef wrapper_fn = build_async_cor_wrapper(
      promise_type, scheduler, llvm_scheduler_type, module, builder);
  LLVMBuildCall2(builder, llvm_scheduler_type, scheduler,
                 (LLVMValueRef[]){
                     wrapper_fn,
