...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    THEN = 290,                    /* THEN  */
    ELSE = 291,                    /* ELSE  */
    FSTRING_START = 292,           /* FSTRING_START  */
    FSTRING_END = 293,             /* FSTRING_END  */
    FSTRING_INTERP_START = 294,    /* FSTRING_INTERP_START  */
    FSTRING_INTERP_END = 295,      /* FSTRING_INTERP_END  */
    FSTRING_TEXT = 296,            /* FSTRING_TEXT  */
    APPLICATION = 297,             /* APPLICATION  */
    DOUBLE_AMP = 298,              /* DOUBLE_AMP  */
    DOUBLE_PIPE = 299,             /* DOUBLE_PIPE  */
    GE = 300,                      /* GE  */
    LE = 301,                      /* LE  */
    EQ = 302,                      /* EQ  */
    NE = 303,                      /* NE  */
