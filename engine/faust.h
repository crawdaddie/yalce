...
NodeRef zita_rev_node(double in_delay, double lf_x, double low_rt60,
                      double mid_rt60, double hf_damping, double eq1_freq,
                      double eq1_level, double eq2_freq, double eq2_level,
                      double wet_dry_mix, double level, NodeRef input);
